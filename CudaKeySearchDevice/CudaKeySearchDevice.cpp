...
void CudaKeySearchDevice::generateStartingPoints() //todo instead of generate key pairs by stride generate by iteration of 1
{
...
void CudaKeySearchDevice::doStep() //todo iterate by stride
{
